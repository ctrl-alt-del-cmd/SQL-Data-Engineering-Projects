...
- **Project Scope:** Built 3 analytical queries that answer questions about the data engineer job market
...
2. [02.top_paying_skills.sql](02.top_paying_skills.sql) - salary analysis with aggregations
...
This project analyzes a **data warehouse** built using a star schema design. The warehouse consists of:
...
2. [Top Paying Skills](02.top_paying_skills.sql) - Analyzes the 25 highest-paying skills with salary and demanded metrics

3. [Optimal Skills](03_optimal_skills.sql) - Calculates an optimal score using natural log of demanded combined with median salary to identify the most valuable skills to learn
...
- **Complex Joins**: Multi-table `Inner Join` operations across `job_postings_fact`,
